...
1.	Based on the information provided on the frame advise what information will 
properly complete the frame below:

| DEST MAC ADDRESS | SOURCE MAC ADDRESS | SOURCE IP ADDRESS | DEST IP ADDRESS | PORT  | PORT | DATA |
| ---------------- | ------------------ | ----------------- | --------------- | ----- | ---- | ---- |
...
| dest MAC ADDRESS | source MAC ADDRESS | source IP ADDRESS | dest IP ADDRESS | PORT  | PORT | DATA |
| ---------------- | ------------------ | ----------------- | --------------- | ----- | ---- | ---- |
| -                | -                  | 172.30.54.10      | 172.29.100.10   | 51029 | 20   |      |
...
| DEST MAC ADDRESS | SOURCE MAC ADDRESS | SOURCE IP ADDRESS | DESTIP ADDRESS | PORT  | PORT | DATA |
| ---------------- | ------------------ | ----------------- | -------------- | ----- | ---- | ---- |
| 000a.f39e.3b02   | 0060.47C7.6C6D     | 172.30.100.200    | -              | 49512 | 22   |      |
...
4.	Based on the information provided on the frame advise what 
information will properly complete the frame below:

| DEST MAC ADDRESS | SOURCE MAC ADDRESS | IP ADDRESS | IP ADDRESS | PORT  | PORT | DATA |
| ---------------- | ------------------ | ---------- | ---------- | ----- | ---- | ---- |
...
| DEST MAC ADDRESS | SOURCE MAC ADDRESS | SOURCE IP ADDRESS | DEST IP ADDRESS | PORT  | DATA |
| ---------------- | ------------------ | ----------------- | --------------- | ----- | ---- |
| 000C.CF9B.A303   | -                  |                   | 192.168.10.12   | 50400 |      |
